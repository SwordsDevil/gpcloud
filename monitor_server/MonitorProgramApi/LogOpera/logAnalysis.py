...
def getLog(RSApath,host,port,user,remotepath,localpath):
...
# putLogInfo('../../ServerCollectInfoApi/logfile.log','./monitor.log','192.168.40.142','Swords','(Swords..0908)','systemInfo')